...
Public Class mPoint
    Dim mPoint As New PictureBox
    Public DownOnPoint As mPoint = Nothing

    Public X, Y As Integer
    Public Look As Image = Image.FromFile("D:\REPOS\Vizmanip\vizmanip-application\blueCircle.png")
    ...
    Public Sub New(x As Integer, y As Integer, elpsSize As Integer)
        If elpsSize < 2 Then elpsSize = 2 'make sure the size is always 2 or greater
        Size = elpsSize
...
Public Class Form1
    ...
    Private mPoints As New List(Of mPoint)
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim newPoint As New PictureBox

    End Sub

    Public Sub display_points(tableData As Dictionary(Of Integer, String()), rowCount As Integer)
        Dim currentRow As String()
        ...
        Dim newImage As Image = Image.FromFile("D:\REPOS\Vizmanip\vizmanip-application\blueCircle.png")
        Dim newPoint As mPoint
            ...
            For counter As Integer = pathStart To pathEnd
                ...
                If counter < rowCount - 1 And counter > 0 Then
                    ...
                    If CheckBox1.Checked = True Then
                        ...
                        End If
                    End If
                    REM Manual Corrections Ghost Image
                    If CheckBox2.Checked = True Then
                        newPoint = New mPoint(1, 1)
                        g.DrawImage(newPoint.Look, New Point(CInt(currentRow(x) - 2) + NumericUpDown2.Value, CInt(currentRow(y) - 2) + NumericUpDown1.Value))
    ...
    Private Sub mPoint_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseUp
        Go = False
        LeftSet = False
        TopSet = False
    End Sub

    Private Sub mPoint_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
        Go = True
    End Sub

    Private Sub mPoint_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseMove
    ...
    Private Sub PictureBox1_MouseDown(sender As Object, e As MouseEventArgs) Handles PictureBox1.MouseDown
        Dim DownOnPoint As mPoint = Nothing
        If e.Button = MouseButtons.Left Then
            For Each dp As mPoint In mPoints
